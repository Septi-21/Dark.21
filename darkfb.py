...
def siapa():
	os.system('clear')
	nama = raw_input("\033[1;97mSia ngarana saha lur ? \033[1;91m: \033[1;92m")
	if nama =="":
		...
		os.system('clear')
		jalan("\033[1;97mSelamat datang \033[1;92m" +nama+ "\n\033[1;97mTerimakasih telah menggunakan tools ini semoga bermanfaat ingat Dosa tanggung sendiri !!")
		time.sleep(1)
		loginSC()
...
def loginSC():
	...
	print"\033[1;97mSilahkan login SC nya dulu broder\n"
        print"\033[1;93m!!Sebelum Login Buat Dulu Akun Fb Baru Lewat Operamini Agar Tidak Terkena Cp!!\n"
